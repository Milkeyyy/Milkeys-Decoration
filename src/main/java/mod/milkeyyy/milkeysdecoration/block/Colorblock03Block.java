...
public class Colorblock03Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:colorblock03")
	public static final Block block = null;
	public Colorblock03Block(MilkeysdecorationModElements instance) {
		super(instance, 59);
	}
