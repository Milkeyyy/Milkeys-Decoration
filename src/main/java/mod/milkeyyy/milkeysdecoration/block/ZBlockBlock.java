...
public class ZBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:zblock")
	public static final Block block = null;
	public ZBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 27);
	}
