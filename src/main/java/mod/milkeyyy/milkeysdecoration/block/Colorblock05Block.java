...
public class Colorblock05Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:colorblock05")
	public static final Block block = null;
	public Colorblock05Block(MilkeysdecorationModElements instance) {
		super(instance, 61);
	}
