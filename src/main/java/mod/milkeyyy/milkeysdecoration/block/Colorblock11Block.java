...
public class Colorblock11Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:colorblock11")
	public static final Block block = null;
	public Colorblock11Block(MilkeysdecorationModElements instance) {
		super(instance, 67);
	}
