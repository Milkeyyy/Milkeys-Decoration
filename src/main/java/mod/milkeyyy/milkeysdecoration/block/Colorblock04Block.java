...
public class Colorblock04Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:colorblock04")
	public static final Block block = null;
	public Colorblock04Block(MilkeysdecorationModElements instance) {
		super(instance, 60);
	}
