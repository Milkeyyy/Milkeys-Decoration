...
public class Road_block_01Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:road_block")
	public static final Block block = null;
	public Road_block_01Block(MilkeysdecorationModElements instance) {
		super(instance, 78);
	}
