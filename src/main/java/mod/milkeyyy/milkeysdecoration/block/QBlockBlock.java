...
public class QBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:qblock")
	public static final Block block = null;
	public QBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 18);
	}
