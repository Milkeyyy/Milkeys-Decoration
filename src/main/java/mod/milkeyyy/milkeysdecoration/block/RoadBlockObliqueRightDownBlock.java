...
public class RoadBlockObliqueRightDownBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:road_block_oblique_right")
	public static final Block block = null;
	public RoadBlockObliqueRightDownBlock(MilkeysdecorationModElements instance) {
		super(instance, 84);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("road_block_oblique_right");
		}
