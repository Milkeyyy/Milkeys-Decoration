...
public class UBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:ublock")
	public static final Block block = null;
	public UBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 22);
	}
