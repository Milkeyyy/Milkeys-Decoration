...
public class Colorblock06Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:colorblock06")
	public static final Block block = null;
	public Colorblock06Block(MilkeysdecorationModElements instance) {
		super(instance, 62);
	}
