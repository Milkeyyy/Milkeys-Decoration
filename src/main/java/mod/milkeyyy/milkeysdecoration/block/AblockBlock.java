...
public class AblockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:ablock")
	public static final Block block = null;
	public AblockBlock(MilkeysdecorationModElements instance) {
		super(instance, 2);
	}
