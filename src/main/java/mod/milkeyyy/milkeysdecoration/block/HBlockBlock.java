...
public class HBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:hblock")
	public static final Block block = null;
	public HBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 9);
	}
