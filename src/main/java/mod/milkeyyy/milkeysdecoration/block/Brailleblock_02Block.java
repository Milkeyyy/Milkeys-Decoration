...
public class Brailleblock_02Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:brailleblock_02")
	public static final Block block = null;
	public Brailleblock_02Block(MilkeysdecorationModElements instance) {
		super(instance, 75);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("brailleblock_02");
		}
