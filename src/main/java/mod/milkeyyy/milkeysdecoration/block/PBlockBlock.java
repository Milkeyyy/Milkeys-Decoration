...
public class PBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:pblock")
	public static final Block block = null;
	public PBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 17);
	}
