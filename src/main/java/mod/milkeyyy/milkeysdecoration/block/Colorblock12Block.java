...
public class Colorblock12Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:colorblock12")
	public static final Block block = null;
	public Colorblock12Block(MilkeysdecorationModElements instance) {
		super(instance, 68);
	}
