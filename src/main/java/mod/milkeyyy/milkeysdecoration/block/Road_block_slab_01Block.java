...
public class Road_block_slab_01Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:road_block_slab_01")
	public static final Block block = null;
	public Road_block_slab_01Block(MilkeysdecorationModElements instance) {
		super(instance, 85);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("road_block_slab_01");
		}
