...
public class VBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:vblock")
	public static final Block block = null;
	public VBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 23);
	}
