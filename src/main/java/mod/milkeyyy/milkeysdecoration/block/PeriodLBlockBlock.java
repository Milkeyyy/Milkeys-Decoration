...
public class PeriodLBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:periodlblock")
	public static final Block block = null;
	public PeriodLBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 41);
	}
