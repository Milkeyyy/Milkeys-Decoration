...
public class Colorblock00Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:colorblock00")
	public static final Block block = null;
	public Colorblock00Block(MilkeysdecorationModElements instance) {
		super(instance, 56);
	}
