...
public class ExclamationBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:exclamationblock")
	public static final Block block = null;
	public ExclamationBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 38);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("exclamationblock");
		}
