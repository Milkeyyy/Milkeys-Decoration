...
public class QuestionBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:questionblock")
	public static final Block block = null;
	public QuestionBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 39);
	}
