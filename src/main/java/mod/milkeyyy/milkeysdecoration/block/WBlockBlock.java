...
public class WBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:wblock")
	public static final Block block = null;
	public WBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 24);
	}
