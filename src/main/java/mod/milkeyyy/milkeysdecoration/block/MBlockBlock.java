...
public class MBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:mblock")
	public static final Block block = null;
	public MBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 14);
	}
