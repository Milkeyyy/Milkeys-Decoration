...
public class Guardrail_01Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:guardrail")
	public static final Block block = null;
	public Guardrail_01Block(MilkeysdecorationModElements instance) {
		super(instance, 89);
	}
