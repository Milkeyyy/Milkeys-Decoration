...
public class OBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:oblock")
	public static final Block block = null;
	public OBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 16);
	}
