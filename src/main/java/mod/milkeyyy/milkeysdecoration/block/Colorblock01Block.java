...
public class Colorblock01Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:colorblock01")
	public static final Block block = null;
	public Colorblock01Block(MilkeysdecorationModElements instance) {
		super(instance, 57);
	}
