...
public class TwoblockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:twoblock")
	public static final Block block = null;
	public TwoblockBlock(MilkeysdecorationModElements instance) {
		super(instance, 30);
	}
