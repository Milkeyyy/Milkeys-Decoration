...
public class LBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:lblock")
	public static final Block block = null;
	public LBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 13);
	}
