...
public class KBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:kblock")
	public static final Block block = null;
	public KBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 12);
	}
