...
public class OneblockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:oneblock")
	public static final Block block = null;
	public OneblockBlock(MilkeysdecorationModElements instance) {
		super(instance, 29);
	}
