...
public class ZeroblockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:zeroblock")
	public static final Block block = null;
	public ZeroblockBlock(MilkeysdecorationModElements instance) {
		super(instance, 28);
	}
