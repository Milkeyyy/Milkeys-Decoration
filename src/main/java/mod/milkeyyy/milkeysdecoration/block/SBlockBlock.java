...
public class SBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:sblock")
	public static final Block block = null;
	public SBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 20);
	}
