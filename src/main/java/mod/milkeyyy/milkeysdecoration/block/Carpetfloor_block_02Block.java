...
public class Carpetfloor_block_02Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:carpetfloor_block_02")
	public static final Block block = null;
	public Carpetfloor_block_02Block(MilkeysdecorationModElements instance) {
		super(instance, 92);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("carpetfloor_block_02");
		}
