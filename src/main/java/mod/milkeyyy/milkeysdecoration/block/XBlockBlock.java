...
public class XBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:xblock")
	public static final Block block = null;
	public XBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 25);
	}
