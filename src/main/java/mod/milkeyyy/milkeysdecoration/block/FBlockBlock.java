...
public class FBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:fblock")
	public static final Block block = null;
	public FBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 7);
	}
