...
public class BBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:bblock")
	public static final Block block = null;
	public BBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 3);
	}
