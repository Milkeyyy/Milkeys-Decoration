...
public class AlphabetBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:alphabetblock")
	public static final Block block = null;
	public AlphabetBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 1);
	}
