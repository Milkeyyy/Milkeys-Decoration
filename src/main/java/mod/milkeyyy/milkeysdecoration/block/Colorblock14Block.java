...
public class Colorblock14Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:colorblock14")
	public static final Block block = null;
	public Colorblock14Block(MilkeysdecorationModElements instance) {
		super(instance, 70);
	}
