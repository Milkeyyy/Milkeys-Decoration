...
public class SpaceBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:spaceblock")
	public static final Block block = null;
	public SpaceBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 54);
	}
