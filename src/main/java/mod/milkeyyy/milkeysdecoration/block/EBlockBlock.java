...
public class EBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:eblock")
	public static final Block block = null;
	public EBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 6);
	}
