...
public class CBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:cblock")
	public static final Block block = null;
	public CBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 4);
	}
