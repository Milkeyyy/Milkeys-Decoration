...
public class CommaLBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:commalblock")
	public static final Block block = null;
	public CommaLBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 43);
	}
