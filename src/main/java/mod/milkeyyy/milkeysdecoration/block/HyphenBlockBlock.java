...
public class HyphenBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:hyphenblock")
	public static final Block block = null;
	public HyphenBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 40);
	}
