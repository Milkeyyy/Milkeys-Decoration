...
public class PeriodRBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:periodrblock")
	public static final Block block = null;
	public PeriodRBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 42);
	}
