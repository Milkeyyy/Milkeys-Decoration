...
public class Road_block_05Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:road_block_center_thick")
	public static final Block block = null;
	public Road_block_05Block(MilkeysdecorationModElements instance) {
		super(instance, 81);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("road_block_center_thick");
		}
