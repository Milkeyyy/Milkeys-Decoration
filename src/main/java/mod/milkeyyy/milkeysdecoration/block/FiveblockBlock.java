...
public class FiveblockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:fiveblock")
	public static final Block block = null;
	public FiveblockBlock(MilkeysdecorationModElements instance) {
		super(instance, 33);
	}
