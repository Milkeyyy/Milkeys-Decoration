...
public class Road_block_oblique_leftBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:road_block_oblique_center")
	public static final Block block = null;
	public Road_block_oblique_leftBlock(MilkeysdecorationModElements instance) {
		super(instance, 82);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("road_block_oblique_center");
		}
