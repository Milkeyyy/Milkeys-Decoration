...
public class YBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:yblock")
	public static final Block block = null;
	public YBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 26);
	}
