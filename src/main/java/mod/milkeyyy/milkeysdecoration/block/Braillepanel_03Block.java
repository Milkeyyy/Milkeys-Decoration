...
public class Braillepanel_03Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:braillepanel_03")
	public static final Block block = null;
	public Braillepanel_03Block(MilkeysdecorationModElements instance) {
		super(instance, 76);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("braillepanel_03");
		}
