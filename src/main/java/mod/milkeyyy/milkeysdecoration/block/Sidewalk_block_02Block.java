...
public class Sidewalk_block_02Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:sidewalk_block_02")
	public static final Block block = null;
	public Sidewalk_block_02Block(MilkeysdecorationModElements instance) {
		super(instance, 87);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("sidewalk_block_02");
		}
