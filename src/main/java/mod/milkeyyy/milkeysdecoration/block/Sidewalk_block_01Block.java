...
public class Sidewalk_block_01Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:sidewalk_block_01")
	public static final Block block = null;
	public Sidewalk_block_01Block(MilkeysdecorationModElements instance) {
		super(instance, 86);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("sidewalk_block_01");
		}
