...
public class Brailleblock_01Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:brailleblock_01")
	public static final Block block = null;
	public Brailleblock_01Block(MilkeysdecorationModElements instance) {
		super(instance, 73);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("brailleblock_01");
		}
