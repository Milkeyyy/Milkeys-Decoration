...
public class CommaRBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:commarblock")
	public static final Block block = null;
	public CommaRBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 44);
	}
