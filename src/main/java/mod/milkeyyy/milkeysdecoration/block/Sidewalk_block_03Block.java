...
public class Sidewalk_block_03Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:sidewalk_block_03")
	public static final Block block = null;
	public Sidewalk_block_03Block(MilkeysdecorationModElements instance) {
		super(instance, 88);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("sidewalk_block_03");
		}
