...
import mod.milkeyyy.milkeysdecoration.procedures.ColorblockguiopenProcedure;
...
public class ColorblockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:colorblock")
	public static final Block block = null;
	public ColorblockBlock(MilkeysdecorationModElements instance) {
		super(instance, 55);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				ColorblockguiopenProcedure.executeProcedure($_dependencies);
			}
