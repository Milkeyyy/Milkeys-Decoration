...
public class Road_block_sideBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:road_block_side")
	public static final Block block = null;
	public Road_block_sideBlock(MilkeysdecorationModElements instance) {
		super(instance, 79);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("road_block_side");
		}
