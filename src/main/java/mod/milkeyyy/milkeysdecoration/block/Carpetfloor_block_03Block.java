...
public class Carpetfloor_block_03Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:carpetfloor_block_03")
	public static final Block block = null;
	public Carpetfloor_block_03Block(MilkeysdecorationModElements instance) {
		super(instance, 93);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("carpetfloor_block_03");
		}
