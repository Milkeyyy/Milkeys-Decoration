...
public class SixblockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:sixblock")
	public static final Block block = null;
	public SixblockBlock(MilkeysdecorationModElements instance) {
		super(instance, 34);
	}
