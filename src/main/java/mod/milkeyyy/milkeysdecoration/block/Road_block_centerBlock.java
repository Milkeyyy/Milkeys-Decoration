...
public class Road_block_centerBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:road_block_center")
	public static final Block block = null;
	public Road_block_centerBlock(MilkeysdecorationModElements instance) {
		super(instance, 80);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("road_block_center");
		}
