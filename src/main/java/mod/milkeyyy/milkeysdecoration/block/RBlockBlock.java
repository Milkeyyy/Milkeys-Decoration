...
public class RBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:rblock")
	public static final Block block = null;
	public RBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 19);
	}
