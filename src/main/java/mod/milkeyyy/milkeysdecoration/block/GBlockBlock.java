...
public class GBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:gblock")
	public static final Block block = null;
	public GBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 8);
	}
