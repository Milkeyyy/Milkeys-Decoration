...
public class EqualBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:equalblock")
	public static final Block block = null;
	public EqualBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 45);
	}
