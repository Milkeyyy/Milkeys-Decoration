...
public class DBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:dblock")
	public static final Block block = null;
	public DBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 5);
	}
