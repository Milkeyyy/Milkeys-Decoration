...
public class TBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:tblock")
	public static final Block block = null;
	public TBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 21);
	}
