...
public class JBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:jblock")
	public static final Block block = null;
	public JBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 11);
	}
