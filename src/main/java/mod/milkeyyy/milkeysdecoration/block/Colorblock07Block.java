...
public class Colorblock07Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:colorblock07")
	public static final Block block = null;
	public Colorblock07Block(MilkeysdecorationModElements instance) {
		super(instance, 63);
	}
