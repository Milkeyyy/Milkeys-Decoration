...
public class NineblockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:nineblock")
	public static final Block block = null;
	public NineblockBlock(MilkeysdecorationModElements instance) {
		super(instance, 37);
	}
