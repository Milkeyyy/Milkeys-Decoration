...
public class IBlockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:iblock")
	public static final Block block = null;
	public IBlockBlock(MilkeysdecorationModElements instance) {
		super(instance, 10);
	}
