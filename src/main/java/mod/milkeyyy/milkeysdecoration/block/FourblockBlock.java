...
public class FourblockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:fourblock")
	public static final Block block = null;
	public FourblockBlock(MilkeysdecorationModElements instance) {
		super(instance, 32);
	}
