...
public class Braillepanel_02Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:braillepanel_02")
	public static final Block block = null;
	public Braillepanel_02Block(MilkeysdecorationModElements instance) {
		super(instance, 74);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("braillepanel_02");
		}
