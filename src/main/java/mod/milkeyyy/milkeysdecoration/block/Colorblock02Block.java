...
public class Colorblock02Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:colorblock02")
	public static final Block block = null;
	public Colorblock02Block(MilkeysdecorationModElements instance) {
		super(instance, 58);
	}
