...
public class Colorblock09Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:colorblock09")
	public static final Block block = null;
	public Colorblock09Block(MilkeysdecorationModElements instance) {
		super(instance, 65);
	}
