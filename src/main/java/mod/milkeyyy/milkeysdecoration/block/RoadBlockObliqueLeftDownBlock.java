...
public class RoadBlockObliqueLeftDownBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:road_block_oblique_left")
	public static final Block block = null;
	public RoadBlockObliqueLeftDownBlock(MilkeysdecorationModElements instance) {
		super(instance, 83);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("road_block_oblique_left");
		}
