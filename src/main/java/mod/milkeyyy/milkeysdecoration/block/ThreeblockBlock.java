...
public class ThreeblockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:threeblock")
	public static final Block block = null;
	public ThreeblockBlock(MilkeysdecorationModElements instance) {
		super(instance, 31);
	}
