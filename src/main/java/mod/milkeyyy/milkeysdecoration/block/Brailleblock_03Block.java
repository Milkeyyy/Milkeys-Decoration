...
public class Brailleblock_03Block extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:brailleblock_03")
	public static final Block block = null;
	public Brailleblock_03Block(MilkeysdecorationModElements instance) {
		super(instance, 77);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("brailleblock_03");
		}
