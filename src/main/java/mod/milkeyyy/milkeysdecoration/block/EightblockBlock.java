...
public class EightblockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:eightblock")
	public static final Block block = null;
	public EightblockBlock(MilkeysdecorationModElements instance) {
		super(instance, 36);
	}
