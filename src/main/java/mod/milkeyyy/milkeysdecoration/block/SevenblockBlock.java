...
public class SevenblockBlock extends MilkeysdecorationModElements.ModElement {
	@ObjectHolder("milkeysdecoration:sevenblock")
	public static final Block block = null;
	public SevenblockBlock(MilkeysdecorationModElements instance) {
		super(instance, 35);
	}
